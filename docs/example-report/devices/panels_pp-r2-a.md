...
|:---|:---|
| Name | pp-r2-a |
| Qualified name | panels/pp-r2-a |
| Kind | patchpanel |
| Site | [(inventory root)](../sites/root.md) |
| Description | The other end of the same permanent cabling, at the top of rack r2. Each of its rear positions is tied to the matching position of pp-r1-a; the front positions are what the servers below are patched into. |
| Vendor | Panduit |
| Model | CPPL24WBLY |
| Serial | — |
| Declared in | panels/panels.yaml#1:25 |
...
|:---|:---|:---|:---|---:|---:|:---|:---|:---|
| rear/7 | cbl-tie-07 | T-007 | copper | 1Gbps | 18m | [pp-r1-a](panels_pp-r1-a.md) | rear/7 | pp-r1-a front/7→rear/7, pp-r2-a rear/7→front/7 (run sw-core-01:GigabitEthernet1/0/7 - srv-app-01:eno1) |
| front/7 | cbl-pp-app07 | P-007B | copper | 1Gbps | 2m | [srv-app-01](hosts_srv-app-01.md) | eno1 | pp-r1-a front/7→rear/7, pp-r2-a rear/7→front/7 (run sw-core-01:GigabitEthernet1/0/7 - srv-app-01:eno1) |
| rear/8 | cbl-tie-08 | T-008 | copper | 1Gbps | 18m | [pp-r1-a](panels_pp-r1-a.md) | rear/8 | pp-r1-a front/8→rear/8, pp-r2-a rear/8→front/8 (run sw-core-01:GigabitEthernet1/0/8 - srv-db-01:eno1) |
| front/8 | cbl-pp-db08 | P-008B | copper | 1Gbps | 2m | [srv-db-01](hosts_srv-db-01.md) | eno1 | pp-r1-a front/8→rear/8, pp-r2-a rear/8→front/8 (run sw-core-01:GigabitEthernet1/0/8 - srv-db-01:eno1) |
| rear/24 | cbl-tie-24 | T-024 | copper | 1Gbps | 18m | [pp-r1-a](panels_pp-r1-a.md) | rear/24 | pp-r1-a front/24→rear/24, pp-r2-a rear/24→front/24 (run sw-core-01:GigabitEthernet1/0/2 - sw-access-01:GigabitEthernet1/0/24) |
| front/24 | cbl-pp-access24 | P-024B | copper | 1Gbps | 2m | [sw-access-01](network_sw-access-01.md) | GigabitEthernet1/0/24 | pp-r1-a front/24→rear/24, pp-r2-a rear/24→front/24 (run sw-core-01:GigabitEthernet1/0/2 - sw-access-01:GigabitEthernet1/0/24) |
| front/9 | cbl-access-pp09 | P-009A | copper | 1Gbps | 1m | [sw-access-01](network_sw-access-01.md) | GigabitEthernet1/0/1 | pp-r2-a front/9→rear/9 (run sw-access-01:GigabitEthernet1/0/1 - ap-ceiling-01:eth0) |
| rear/9 | cbl-pp-ap09 | T-009 | copper | 1Gbps | 24m | [ap-ceiling-01](hosts_ap-ceiling-01.md) | eth0 | pp-r2-a front/9→rear/9 (run sw-access-01:GigabitEthernet1/0/1 - ap-ceiling-01:eth0) |
