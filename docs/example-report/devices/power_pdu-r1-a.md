...
|:---|:---|
| Name | pdu-r1-a |
| Qualified name | power/pdu-r1-a |
| Kind | pdu |
| Site | [(inventory root)](../sites/root.md) |
| Description | A-side strip in rack r1, on the utility feed. Every dual-corded device in this rack has one cord here and one in pdu-r1-b; the two strips are on different feeds, which is what makes the second cord worth having. |
| Vendor | APC |
| Model | AP8853 |
| Serial | — |
| Declared in | power/pdus.yaml#0:1 |
