...
|---|---|---|---|
| `-k`, `--kind` | `[switch\|router\|hub\|computer\|server\|cable\|adapter\|tunnel\|patchpanel\|pdu\|template]` | — | Emit the schema for a single document kind instead of all of them. |
