...
The graph is built at [`--layer physical`](../README.md#layers-physical-l1-l2-l3-overlay-and-rack)
...
[`netgraph render -f json`](../README.md#the-json-export), which exports the
...
- [`README.md`](../README.md#the-json-export) — `render -f json`, the lossless
  export.
