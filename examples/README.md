...
Three complete, self-consistent inventories. All of them load without a single
...
Both trees follow the layout suggested in `docs/schema.md` §2.5: directories
