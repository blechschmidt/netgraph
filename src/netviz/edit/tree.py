...
:class:`~netviz.edit.errors.ConflictError` and not a lost edit — which is the
...
from netviz.edit.errors import ConflictError, EditError
from netviz.edit.placement import FileFacts, namespace_of_file
from netviz.edit.roundtrip import YamlDocument, YamlFile
from netviz.fsio import write_text_atomically
from netviz.loader.inventory import Inventory, SourceLocation
from netviz.loader.tree import Overlay, iter_inventory_files
from netviz.models import LAYOUT_KIND
...
class EditableTree:
    ...
    def snapshot(self) -> TreeSnapshot:
        ...
        are already finished and journalled. See :class:`~netviz.edit.Batch`.
        """
        return TreeSnapshot(
            files={
                relative: _Frozen(
    ...
    def find_document(self, *, kind: str, name: str, namespace: str = "") -> tuple[str, int] | None:
        ...
        (:data:`~netviz.models.annotation.COHERENCE_RULE`), so a reload
    ...
    def overlay(self) -> Overlay:
        """The pending changes, in the form :func:`~netviz.loader.load_tree` takes.
    ...
    def facts(self, inventory: Inventory) -> dict[str, FileFacts]:
        """What each file holds, for :func:`~netviz.edit.placement.choose_file`.
