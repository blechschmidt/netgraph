...
:class:`~netviz.edit.session.EditSession` is already atomic *per operation*:
...
back if any of them refuses (:meth:`~netviz.edit.tree.EditableTree.snapshot`).
...
from netviz.edit.apply import AppliedOperation
from netviz.edit.errors import EditError
from netviz.edit.operations import Operation
from netviz.edit.session import EditSession, EditSummary
