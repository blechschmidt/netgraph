...
from netviz.models.scalars import ElementRef
...
#: :mod:`netviz.schema`. Deriving the published schema from the constants
...
def _normalise_ssh_key(value: Any) -> Any:
    ...
    ``netviz plan`` over a re-pasted file empty rather than noisy.
    """
