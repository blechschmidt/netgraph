...
#: The only ``apiVersion`` this revision of netviz understands (§12).
API_VERSION: Final = "netviz.dev/v1alpha1"
...
#: JSON Schema of :mod:`netviz.schema` has to advertise exactly the grammar
...
#: (:meth:`netviz.loader.Inventory.lookup`, §2.2).
