...
secret in version control, and netviz has no use for one.
"""
...
#: reason :data:`~netviz.models.scalars.BITRATE_PATTERN` is.
...
class VrfDefinition(NetvizModel):
    ...
    distinguisher is recorded because MPLS needs it, not because netviz
...
class RoutingConfig(NetvizModel):
