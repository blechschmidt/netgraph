...
and what is patched into what — is :mod:`netviz.models.patchpanel` and
...
``spec.outlets`` / ``spec.capacity_watts``
    On a :mod:`~netviz.models.pdu` document: the outlets that exist and how
...
from netviz.models.scalars import Boolean, ElementRef, Watts
