...
from netviz.models.scalars import BitRate, ElementRef, IfName, LengthMetres
...
class InterfaceRef(NetvizModel):
    ...
    The device part is an :data:`~netviz.models.scalars.ElementRef`, not a
