...
from netviz.render.ids import slug as id_slug
...
def page_slug(name: str) -> str:
    ...
    Built on :func:`netviz.render.ids.slug`, which is the same reduction the
    ...
    XML id must) and passed through :func:`~netviz.fsio.safe_file_stem` (an
