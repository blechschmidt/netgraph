...
say. So every page carries three facts: the netviz version, the time of
...
def resolve_timestamp(
    ...
    Raises:
        NetvizError: ``given`` is neither ``none`` nor a timestamp Python can
...
def _parse(text: str) -> datetime:
    ...
    # ``fromisoformat`` learned to read a trailing ``Z`` in 3.11 and netviz
