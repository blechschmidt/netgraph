...
goes dark while I do*. That is the question :mod:`netviz.impact` already
...
netviz could not see how it would cut reachability, not that a person should
...
from netviz.converge.model import Batch
from netviz.impact.engine import simulate
from netviz.impact.model import ImpactError
