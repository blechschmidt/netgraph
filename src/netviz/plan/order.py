...
* **Deletions run first, dependents before dependees.** A cable is removed
  ...
  be refused — :class:`~netviz.edit.errors.CascadeRequired` — or, worse,
...
from netviz.edit.references import references_of
from netviz.loader.inventory import Inventory, namespace_of
from netviz.plan.address import Address, address_of
from netviz.plan.model import Action, Change
