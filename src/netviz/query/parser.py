"""Recursive descent over :mod:`netviz.query.lexer`'s tokens.
...
from netviz.query.lexer import Token, TokenKind, tokenize
...
class Query:
    ...
    span of it, and because ``netviz query --json`` echoes the query it
...
def parse(text: str, *, source: str = "query") -> Query:
    ...
    Every name is resolved against :mod:`netviz.query.attributes` and every
