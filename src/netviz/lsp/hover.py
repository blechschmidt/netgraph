...
:mod:`netviz.lsp.index` resolved it to decide the span was a reference at all.
...
from netviz.lsp.index import Anchor, AnchorKind
from netviz.lsp.schemaindex import SchemaIndex
