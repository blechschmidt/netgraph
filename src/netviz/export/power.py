...
from netviz.export.names import csv_cell
from netviz.loader.inventory import short_name
from netviz.models import format_watts
from netviz.power import Feed, PduLoad, PoeBudget, PowerPlan, power_plan
from netviz.render.graph import Graph, Layer, Node
...
def _csv(rows: Sequence[_Row]) -> str:
    ...
    Every cell goes through :func:`~netviz.export.names.csv_cell` on the way
