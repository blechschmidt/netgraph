"""The resolved command line of ``netgraph report``, in one object.
...
what makes :func:`netgraph.report.generate` a pure function of its arguments, and
...
class Options:
    ...
    #: ``None`` lets :func:`~netgraph.report.collect.site_groups` decide.
    ...
    #: The version of netgraph that produced the report. A field rather than a
