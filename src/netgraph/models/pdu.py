...
:mod:`netgraph.models.patchpanel` is for the data half: a strip of numbered
...
(two utility feeds, two UPS strings, a UPS and a generator), and netgraph's job
...
#: What :func:`~netgraph.models.positions.expand_positions` is told a PDU's
