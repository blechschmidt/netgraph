...
*state of a box* in exactly the sense :mod:`netgraph.models.routing` means it,
...
reason :data:`~netgraph.models.device.GLOBAL_VRF` is.
...
#: reasons :data:`~netgraph.models.device.GLOBAL_VRF` gives — it is not a name
...
class NetnsDefinition(NetgraphModel):
