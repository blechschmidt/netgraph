"""The diagram, as ``netgraph web`` needs it: an embeddable, inert fragment.

The rewriting itself is :mod:`netgraph.render.fragment`, which two embedders
share — this preview and the self-contained page ``netgraph render -f html``
...
from netgraph.render.fragment import SVG_NAMESPACE, XLINK_NAMESPACE, fragment
