...
go through :meth:`~netgraph.web.session.EditingSession._commit`, and everything
else arrives at :class:`~netgraph.web.session.TreeWatcher` — but until this
...
:meth:`~netgraph.web.session.EditingSession.apply` and the content hash in
:meth:`~netgraph.web.session.EditingSession.write_file` remain the only gates on
