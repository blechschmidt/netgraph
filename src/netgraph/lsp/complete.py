...
(:mod:`netgraph.schema`), so it is right by construction and stays right.
...
:class:`~netgraph.edit.references.ReferenceRole` paths, listed once in
...
from netgraph.lsp.schemaindex import Property, SchemaIndex
from netgraph.models import Adapter, Cable, Element, Group, PatchPanel, Pdu, Tunnel
...
#: :func:`~netgraph.edit.references.references_of` reads, so a field that stops
