...
with :class:`~netgraph.edit.operations.RenameElement`, which rewrites every
...
1. An explicit ``netgraph.dev/id`` annotation. If somebody has told us what the
...
from netgraph.models import Adapter, Cable, Device, ElementBase, PatchPanel, Pdu, Tunnel
from netgraph.plan.address import DEVICE_TYPE, Address
...
STABLE_ID_ANNOTATION: Final = "netgraph.dev/id"
