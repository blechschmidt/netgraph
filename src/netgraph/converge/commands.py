"""Turning an intent into lines: netgraph's own imperative grammar, and its inverse.
...
dialect of :mod:`netgraph.export.config.neutral` -- the same stanza names
...
from netgraph.converge.intent import Intent, IntentKind, article
...
def _set(interface: str, field: str, value: str | None, *, literal: bool = False) -> str:
    ...
    ever observed. ``unset`` says exactly that: take the netgraph-set value off
