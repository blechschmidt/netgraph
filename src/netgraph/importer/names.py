...
Nothing guarantees that a chassis name or a port description is a legal netgraph
...
def element_name(raw: str) -> SanitisedName:
    ...
    name, because a device netgraph cannot name is a device the operator has to
    look at.
    """
