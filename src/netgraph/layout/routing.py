...
A stored arrangement says where the *nodes* go (:mod:`netgraph.layout.geometry`)
...
:mod:`netgraph.layout` — Graphviz's own, so a route can be handed straight
back to it.
"""
...
class Anchor:
    ...
    #: one-line ``netgraph layout --write``.
    measured: bool = True
...
def route(
    ...
    *,
    ...
    Args:
        ...
        style: One of :class:`~netgraph.layout.geometry.Routing`.
