...
``--kind switch --kind router --namespace sites/north`` was netgraph's first
...
:func:`as_query` renders a :class:`~netgraph.render.graph.FilterSpec` as the
query text it means. ``netgraph query --explain`` prints it, ``docs/query.md``
...
:class:`~netgraph.render.graph.FilterSpec`'s own rule, restated in the language.
"""

from __future__ import annotations

from netgraph.query.lexer import PUNCTUATION
