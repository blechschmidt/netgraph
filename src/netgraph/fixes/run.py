...
from netgraph.edit.operations import Operation, RemoveFile, WriteFile
from netgraph.edit.session import EditSession
from netgraph.errors import count_text
from netgraph.fixes.model import Fix
from netgraph.fixes.producers import fixes_for
    ...
    *,
    ...
    Args:
        ...
        settings: How to grade findings, so the run sees what
            ``netgraph validate`` would see in this tree.
    ...
    *,
    ...
    Raises:
        EditError: The operations could not be applied. The session is rolled
            ...
            :meth:`~netgraph.edit.EditSession.apply_all` would not, a batch
...
def _regressions(before: Sequence[Finding], after: Sequence[Finding]) -> tuple[Finding, ...]:
    ...
    :meth:`netgraph.edit.EditSession.check` does it that way: repairing one
