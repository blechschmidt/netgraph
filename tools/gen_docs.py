...
SUMMARY: Final[dict[str, str]] = {
    ...
    "test": "Grade the assertions the inventory declares about itself.",
    ...
    "converge plan": "Turn drift into an ordered, per-device remediation plan.",
    "diff": "Draw the difference between two inventory states as one diagram.",
    "review": "Write a change up as one pull-request review: changeset, diagram, new findings.",
    "log": "List the commits that changed the inventory, and what each one changed.",
    ...
    "lsp": "Serve completion, diagnostics and rename to an editor over LSP.",
    ...
    "ansible path": "Print the collections path holding the shipped Ansible collection.",
    "ansible install": "Copy that collection into a control node's collections path.",
    "ansible inventory": "Print the dynamic inventory the plugin builds, queries and all.",
